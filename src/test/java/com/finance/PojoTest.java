...
//					}
//					
//					UserAccount ua = userAccountService.getByUserAndType(u, UserEnum.UserWaterType.score);
...
//		
//		UserAccount ua = userAccountService.getByUserAndType(u, UserEnum.UserWaterType.score);
//		System.out.println("FINALLY get UserAccount:"+ua.getType().name()+","+ua.getValue());
//	}
	
//	@Test
//	public void t6(){
//		UserAccount ua = userAccountService.getByUserAndType(userService.getUser(116), UserEnum.UserWaterType.score,false);
